...
public class Appointment {
	...
	/*public Appointment(int userId2, String fullname2, String gender2, String age2, String appoint_date, String email2,
			String phno2, String diseases2, int doctor_id, String address2, String status2) {
		// TODO Auto-generated constructor stub
		super();
		//this.id = id;
		this.userId = userId;
