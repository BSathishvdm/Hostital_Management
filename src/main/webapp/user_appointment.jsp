...
<body style="background-image: url('img/bk4.jpg');">
	...
	<div class="container p-1" style="color:black">
				<div class="col-md-6 offset-md-3">
		<div class="row">
<!-- 			<div class="col-md-6 p-7"> -->
<!-- 			<img alt="..." src="img/doc6.jpg" width="400px" height="380px"> -->
<!-- 			</div> -->
<!-- 				<div class="col-md-6"> -->
...
<!-- 						<div class="card-body"> -->
							...
							<form class="row g-3" action="appAppointment" method="post">
								...
								<div class="col-md-6">
									<label for="inputEmail4" class="form-Label">Ages</label> <input
										required type="number" class="form-control" name="age">
								</div>

								<div class="col-md-6">
									<label for="inputEmail4" class="form-Label">Appointment
										Dater</label> <input type="date" class="form-control" required
										name="appoint_date">
								</div>
