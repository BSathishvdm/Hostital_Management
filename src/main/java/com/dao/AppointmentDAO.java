...
public AppointmentDAO(Connection conn) {
 ...
 public List<Appointment> getUserById(int userId){
	 List<Appointment> list = new ArrayList<Appointment>();
	 Appointment ap=null;
	 try {
		 String sql="select * from appointment where user_id=?";
...
public List<Appointment> getAllAppointment1(int userId) {
	 List<Appointment> list = new ArrayList<Appointment>();
	 ...
	 try {
		 ...
		 while(rs.next()) {
			 ...
			 ap1.setUserId(rs.getInt(2));
			 ap1.setFullName(rs.getString(3));
			 ap1.setGender(rs.getString(4));
			 ap1.setAge(rs.getString(5));
			 ap1.setAppoinDate(rs.getString(6));
			 ap1.setEmail(rs.getString(7));
			 ap1.setPhNo(rs.getString(8));
			 ap1.setDiseases(rs.getString(9));
			 ap1.setDoctorId(rs.getInt(10));
			 ap1.setAddress(rs.getString(11));
			 ap1.setStatus(rs.getString(12));
			 list.add(ap1);
		 }
	 }catch(Exception e) {
		 e.printStackTrace();
...
public List<Appointment> getAllAppointmentByLoginUser1(int userId){
	 List<Appointment> list = new ArrayList<Appointment>();
	 Appointment ap=null;
	 try {
		 String sql="select * from appointment where user_id=?";
